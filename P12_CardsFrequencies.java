...
public class P12_CardsFrequencies {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter your cards here: ");
		System.out.println();
		...
		for (Map.Entry<String, Integer> stringIntegerEntry : cardsByCount.entrySet()) {
			double frequence = ((double)stringIntegerEntry.getValue() * 100 / input.length);
			
			System.out.printf("%s -> %.2f%%", stringIntegerEntry.getKey(), frequence);
			System.out.println();
		}
	}
}